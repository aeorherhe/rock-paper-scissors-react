...
import { getWinnerEasy } from "../../services/getWinner";
...
const easySlice = createSlice({
  ...
  reducers: {
    ...
    // check winner
    checkWinner: (state) => {
      state.winner = getWinnerEasy(state.playersChoice, state.computersChoice);
...
playAgain, resetGame, checkWinner, showStatsFunc, setDifficulty, computerPicks  } = easySlice.actions;
